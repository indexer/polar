...
public class FeedProvider extends ContentProvider {
  ...
  @Override public boolean onCreate() {
    mOpenHelper = new FeedDataBase(getContext());
    return true;
  }
  ...
  @Override public String getType(Uri uri) {
    ...
    switch (match) {
      case ITEMS:
        return FeedContract.Items.CONTENT_TYPE;
      case ITEMS__ID:
        return FeedContract.Items.CONTENT_ITEM_TYPE;
      default:
  ...
  @Override public Uri insert(Uri uri, ContentValues values) {
    ...
    switch (match) {
      case ITEMS: {
        ...
        return FeedContract.Items.buildItemUri(_id);
      }
      default: {
        throw new UnsupportedOperationException("Unknown uri: " + uri);
      }
  ...
  private SelectionBuilder buildSelection(Uri uri, int match, SelectionBuilder builder) {
    ...
    switch (match) {
      ...
      case ITEMS__ID: {
        ...
        return builder.table(Tables.ITEMS).where(FeedContract.Items._ID + "=?", _id);
      }
      default: {
        throw new UnsupportedOperationException("Unknown uri: " + uri);
      }
